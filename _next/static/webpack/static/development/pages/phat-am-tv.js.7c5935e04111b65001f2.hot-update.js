...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VietnameseSyllables; });
...
function VietnameseSyllables() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null),
      activeButton = _useState[0],
      setActiveButton = _useState[1];

  var audioRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(new Audio()); // Mảng 2 chiều thể hiện chính xác layout trong ảnh
  ...
  var playSyllable = function playSyllable(syllable) {
    // if (!syllable) return; // Không làm gì nếu ô trống
    // // Phát âm thanh
  ...
  })), __jsx("span", null, "B\u1EA3n 2025"), __jsx("audio", {
    ref: audioRef,
    hidden: true
  }))));
}
...
//# sourceMappingURL=phat-am-tv.js.7c5935e04111b65001f2.hot-update.js.map