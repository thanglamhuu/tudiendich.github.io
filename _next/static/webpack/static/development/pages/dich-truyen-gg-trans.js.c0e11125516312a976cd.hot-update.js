...
var sample = 'Quacking và giết! Nghe những lời của Dao Gushu, vẻ mặt của Shenqi.\n\n Mở một mình giống như một con kiến! Nó đã hoàn toàn vượt quá nhận.'; // var sample = '在他左右两边,有七位九成神性境强者。';
...
function (_Component) {
  ...
  function DictComponent(props) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_11___default.a.get('/static/TaCoNhatKiemTest.txt').then(function (res) {
      _this.setState({
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(DictComponent, [{
    ...
    value: function updateTudien() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.get(pathDictThayThe).then(function (res) {
        updateDictThayThe(_this2, res.data);
      });
    }
  }, {
    key: "trans",
    value: function trans() {
      ...
      typingChinesse = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_16__["xoaKiTuThuaCopyTuTrang"])(typingChinesse);
      console.log('trans', typingChinesse);
      var nghiaViet = '';
    ...
    value: function render() {
      ...
      return __jsx("div", null, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Row"], null, __jsx("h2", {
        ...
        target: "_blank"
      }, "_TamLinh247")), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_10__["Row"], null, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_10__["FormGroup"], {
        style: {
          width: '100%'
        }
...
//# sourceMappingURL=dich-truyen-gg-trans.js.c0e11125516312a976cd.hot-update.js.map