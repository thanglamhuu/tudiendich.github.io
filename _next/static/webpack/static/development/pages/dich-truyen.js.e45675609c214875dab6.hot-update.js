...
function (_Component) {
  ...
  function DictComponent(props) {
    ...
    _this.luuBanDichVaoFbDB = _this.luuBanDichVaoFbDB.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this));
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__["default"])(DictComponent, [{
    ...
    value: function btnThemTuMoiClick() {
      ...
      try {
        ...
        var dbPath = "".concat(dbPathNdhp, "/").concat(tumoiNghia);
    ...
    value: function trans() {
      ...
      translation_google__WEBPACK_IMPORTED_MODULE_12___default()(typingChinesse, {
        ...
        for (var word in dict) {
          console.log(word, Object(_utils_utils__WEBPACK_IMPORTED_MODULE_25__["replaceAll"])(nghiaViet, word, dict[word].nghia), Object(_utils_utils__WEBPACK_IMPORTED_MODULE_25__["replaceAll"])(nghiaViet, 'Ye Guan', 'Diệp Quân'));
          nghiaViet = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_25__["replaceAll"])(nghiaViet, word, dict[word].nghia);
        }
    ...
    value: function transDB() {
      ...
      var doichieu = ''; //Ghep cau chu Han voi Chu viet
      ...
      this.luuBanDichVaoFbDB();
    }
  }, {
    key: "luuBanDichVaoFbDB",
    value: function luuBanDichVaoFbDB() {
      var _this$state7 = this.state,
          typingChinesse = _this$state7.typingChinesse,
          nghiaViet = _this$state7.nghiaViet,
          dict = _this$state7.dict,
          dictChuHan = _this$state7.dictChuHan,
    ...
    value: function render() {
      ...
      var _this$state8 = this.state,
          nghiaViet = _this$state8.nghiaViet,
          typingChinesse = _this$state8.typingChinesse,
          chinesse = _this$state8.chinesse,
          bacKinh = _this$state8.bacKinh,
          loading = _this$state8.loading,
          dict = _this$state8.dict,
          newWord = _this$state8.newWord,
          newHanViet = _this$state8.newHanViet,
          doichieu = _this$state8.doichieu,
          seletedDoiChieu = _this$state8.seletedDoiChieu,
          newNghia = _this$state8.newNghia,
          blnchiHienNghiaViet = _this$state8.blnchiHienNghiaViet,
          tumoiCh = _this$state8.tumoiCh,
          tumoiNghia = _this$state8.tumoiNghia,
          tumoiReplace = _this$state8.tumoiReplace,
          chuonghdkt = _this$state8.chuonghdkt,
          dictPath = _this$state8.dictPath; // Build Cards for Listing
...
//# sourceMappingURL=dich-truyen.js.e45675609c214875dab6.hot-update.js.map