...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(DictComponent, [{
    ...
    value: function render() {
      ...
      }, "L\u1EA5y k\u1EBFt qu\u1EA3 sang ngh\u0129a Vi\u1EC7t"), __jsx("button", {
        className: "btnProcess",
        onClick: this.chiHienNghiaViet,
        style: {
          marginLeft: 100
        }
      }, "Ch\u1EC9 hi\u1EC7n ngh\u0129a Vi\u1EC7t"))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_13__["Row"], {
        style: {
          paddingTop: '10px'
        }
...
//# sourceMappingURL=dich-truyen.js.1509fc159cd56068455b.hot-update.js.map