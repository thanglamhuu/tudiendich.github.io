...
function (_Component) {
  ...
  function DictComponent(props) {
    ...
    // axios.get(pathDictHanVietThayThe).then((res) => {
    //   this.setState({dictHv:res.data, loading: false});
    // });

    _this.updateTudien(); // axios.get(pathDictThayThe).then((res) => {
    //   updateDictThayThe(this,res.data);
    // });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(DictComponent, [{
    ...
    value: function updateTudien() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_11___default.a.get(pathDictThayThe).then(function (res) {
        ...
        for (var word in dict) {
          dictHv[word].ch = dict[word].nghia;
        }
...
//# sourceMappingURL=dich-truyen-gg-trans.js.8e30a76594415f91bcd2.hot-update.js.map