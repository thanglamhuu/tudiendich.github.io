...
/* harmony import */ var react_textarea_autosize__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! react-textarea-autosize */ "./node_modules/react-textarea-autosize/dist/react-textarea-autosize.esm.browser.js");
/* harmony import */ var _loader__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./loader */ "./components/tuDien/loader.js");
/* harmony import */ var _ChuHan__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./ChuHan */ "./components/tuDien/ChuHan.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../utils/utils */ "./utils/utils.js");
/* harmony import */ var _dict_book_data__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./dict-book-data */ "./components/tuDien/dict-book-data.js");
/* harmony import */ var _utils_analystics__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ../../utils/analystics */ "./utils/analystics.js");
...
function getDisplayHanViet(mean) {
  if (mean && mean["hv"]) {
    ...
    _utils_analystics__WEBPACK_IMPORTED_MODULE_24__["trackEvent"]('ThieuTu', 'Han', _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_8___default()(mean));
    return '';
  }
}
...
function processWord(chinessArray, i, dict, textScripts, bacKinhs) {
  ...
  if (i < chinessArray.length - 5) {
    word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 1]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 2]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 3]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 4]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 5]);
    mean = dict[word];
  ...
  if (i < chinessArray.length - 4) {
    word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 1]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 2]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 3]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 4]);
    mean = dict[word];
    console.log('processWord word, mean', word, mean);
  ...
  if (i < chinessArray.length - 3) {
    word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 1]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 2]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 3]);
    mean = dict[word];
    console.log('processWord word, mean', word, mean);
  ...
  if (i < chinessArray.length - 2) {
    word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 1]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 2]);
    mean = dict[word];
  ...
  if (i < chinessArray.length - 1) {
    word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i]) + Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i + 1]);
    mean = dict[word];
  ...
  mean = dict[Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinneseNoSign"])(chinessArray[i])];
  var hv = '';
...
function getChuHanOneWord(chinesse, dict) {
  var chinessArray = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["chuanHoaChinesseV2"])(chinesse);
  var textScripts = [];
  var mean;
  var word;
  var i = 0;
...
function parserScriptCau(cau, dict) {
  var cacDoan = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(cau, ',', ',#'), '，', ',#'), '：', ':#'), ':', ':#').split('#');
  var j = 0;
  var textScripts = [];
...
function updateNghiaViet(that) {
  ...
  nghiaViet = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["xoaKiTuThuaCopyTuTrang"])(typingChinesse);

  for (var word in dict) {
    nghiaViet = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(nghiaViet, word, dict[word].nghia);
  }
...
function (_Component) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 3;
              _context.next = 6;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(_dict_book_data__WEBPACK_IMPORTED_MODULE_23__["default"].getDictBookData());

            case 6:
              props.dictBook = _context.sent;
              _context.next = 9;
              return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.awrap(_dict_book_data__WEBPACK_IMPORTED_MODULE_23__["default"].getDictTruyenData());
  ...
  function DictComponent(props) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_17___default.a.get('/static/baiChuHan.txt').then(function (res) {
      _this.setState({
        typingChinesse: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["xoaKiTuThuaCopyTuTrang"])(res.data)
      });
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_6__["default"])(DictComponent, [{
    ...
    value: function onChangeHandlerHanViet(e) {
      this.setState({
        hanViet: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["correctTyping"])(e.target.value)
      });
    }
  }, {
    ...
    value: function onChangeHandlerNewNghia(e) {
      this.setState({
        newNghia: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["correctTyping"])(e.target.value)
      });
    }
  }, {
    ...
    value: function onChangeHandlerNewHanViet(e) {
      this.setState({
        newHanViet: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["correctTyping"])(e.target.value)
      });
    }
  }, {
    ...
    value: function onChangeHandlerBacKinh(e) {
      this.setState({
        bacKinh: Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["correctTyping"])(e.target.value)
      });
    }
  }, {
    ...
    value: function onDoiChieuSelect(event) {
      ...
      var textScripts = [];
      var cacCau = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(selection, '.', '.#'), '. ', '.#'), '? ', '?#'), '。', '.#').split('#');
      var i = 0;
    ...
    value: function lamMinVanBan() {
      ...
      typingChinesse = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["xoaKiTuThuaCopyTuTrang"])(typingChinesse);
      this.setState({
        typingChinesse: typingChinesse
      });
      console.log("lamMinVanBan");
      _utils_analystics__WEBPACK_IMPORTED_MODULE_24__["trackEvent"]('Dich truyen', 'lam min', 'lam min');
    }
  }, {
    key: "reportNew",
    value: function reportNew() {
      ...
      _utils_analystics__WEBPACK_IMPORTED_MODULE_24__["trackEvent"]("Report", "newWord", json);
      this.setState({
        newWord: '',
        newHanViet: '',
        newNghia: ''
    ...
    value: function btnLayChuong() {
      ...
      try {
        axios__WEBPACK_IMPORTED_MODULE_17___default.a.get("https://thanglamhuu.github.io/thaz.github.io/feibzw/dataHtml/".concat(chuonghdkt, ".json")).then(function (res) {
          var content = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(res.data.title + '\n' + res.data.content, '<p>', '\n');
          content = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(content, '</p>', '');
    ...
    value: function btnChuongTiep() {
      ...
      try {
        axios__WEBPACK_IMPORTED_MODULE_17___default.a.get("https://thanglamhuu.github.io/thaz.github.io/feibzw/dataHtml/".concat(chuongTiep, ".json")).then(function (res) {
          var content = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(res.data.title + '\n' + res.data.content, '<p>', '\n');
          content = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(content, '</p>', '');
    ...
    value: function trans() {
      ...
      translation_google__WEBPACK_IMPORTED_MODULE_12___default()(typingChinesse, {
        ...
        for (var word in dict) {
          console.log(word, Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(nghiaViet, word, dict[word].nghia), Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(nghiaViet, 'Ye Guan', 'Diệp Quân'));
          nghiaViet = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(nghiaViet, word, dict[word].nghia);
    ...
    value: function render() {
      ...
      if (loading) {
        chuHans = __jsx(_loader__WEBPACK_IMPORTED_MODULE_20__["default"], null);
      } else if (chinesse) {
        chuHans = chinesse.map(function (item) {
          return __jsx(_ChuHan__WEBPACK_IMPORTED_MODULE_21__["default"], {
            id: i++,
            key: Math.random(),
      ...
      return __jsx("div", null, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Row"], null, __jsx("h2", {
        className: "h1Title"
      ...
      }, "D\u1ECBch"), __jsx("div", null, blnchiHienNghiaViet && react_render_html__WEBPACK_IMPORTED_MODULE_11___default()(Object(_utils_utils__WEBPACK_IMPORTED_MODULE_22__["replaceAll"])(nghiaViet, '\n', '<br>')))), !blnchiHienNghiaViet && __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Row"], {
        style: {
          paddingTop: '10px'
        }
      }, __jsx("a", {
        ...
        target: "_blank"
      }, "chuong-3376")), !blnchiHienNghiaViet && __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Row"], null, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["FormGroup"], {
        style: {
          width: '100%'
        }
      }, __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Label"], {
        "for": "inputChuHan"
      }, "Nh\u1EADp n\u1ED9i dung ch\u1EEF H\xE1n"), __jsx(react_textarea_autosize__WEBPACK_IMPORTED_MODULE_19__["default"], {
        className: "txtAutoSize",
        id: "inputChuHan",
        placeholder: "Ch\u1EEF H\xE1n",
        value: typingChinesse,
        onChange: this.onChangeHandlerChuHan
      }))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Row"], {
        style: {
          paddingTop: '10px'
        }
      }, __jsx("div", {
      ...
      }, "Th\xEAm"))), !blnchiHienNghiaViet && __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Row"], {
        style: {
          paddingTop: '10px'
        }
      }, __jsx("h4", null, "\u0110\u1ED1i Chi\u1EBFu"), chuHans, __jsx(react_textarea_autosize__WEBPACK_IMPORTED_MODULE_19__["default"], {
        className: "txtAutoSize",
        id: "inputDoiChieu",
      ...
      })), !blnchiHienNghiaViet && __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_16__["Row"], {
        style: {
          paddingTop: '10px'
        }
      }, __jsx("h4", null, "Ch\u1EC9nh s\u1EEDa l\u1EA1i n\u1ED9i dung b\u1EA3n d\u1ECBch t\u1EA1i \u0111\xE2y"), __jsx(react_textarea_autosize__WEBPACK_IMPORTED_MODULE_19__["default"], {
        className: "txtAutoSize",
        id: "inputNghiaViet",
        placeholder: "d\u1ECBch ngh\u0129a",
        value: nghiaViet,
...
//# sourceMappingURL=dich-truyen.js.72d9abe4cdc600a0b434.hot-update.js.map