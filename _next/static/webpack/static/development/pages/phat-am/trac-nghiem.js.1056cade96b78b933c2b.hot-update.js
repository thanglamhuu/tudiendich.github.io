  ...
  syllablesTable.map(function (row, rowIndex) {
    return row.map(function (syllable, colIndex) {
      exercises.push({
        ...
        mp3: "/static/phatam/".concat(rowIndex >= 10 ? rowIndex : '0' + rowIndex).concat(colIndex < 10 ? colIndex : 'a').concat(removeVietnameseTones(syllable), ".mp3"),
        choices: ['ip', 'ap', 'iêm', 'yêm'],
...
//# sourceMappingURL=trac-nghiem.js.1056cade96b78b933c2b.hot-update.js.map