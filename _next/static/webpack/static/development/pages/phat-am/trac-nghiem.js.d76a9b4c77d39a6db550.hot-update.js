...
function getChoices(rowIndex, colIndex) {
  ...
  for (var i = 9; i > 0; i-- || choices.length > 4) {
    ...
    console.log('j', j, 'syllablesTable[rowIndex]', syllablesTable[rowIndex], 'am', syllablesTable[rowIndex][j]);

    if (!choices.find(syllablesTable[rowIndex][j])) {
...
//# sourceMappingURL=trac-nghiem.js.d76a9b4c77d39a6db550.hot-update.js.map