...
function getChoices(rowIndex, colIndex) {
  ...
  for (var i = 9; i > 0; i-- || choices.length > 4) {
    ...
    console.log('j', j, 'am', syllablesTable[rowIndex][j]); // if (!choices.find(syllablesTable[rowIndex][j])){
...
//# sourceMappingURL=trac-nghiem.js.259f1fca755293d1ecf1.hot-update.js.map