...
var QuizComponent = function QuizComponent(_ref) {
  ...
  var _exercises$currentInd = exercises[currentIndex],
      ...
      question = _exercises$currentInd.question;
  return __jsx("div", {
    style: {
      padding: '20px',
  ...
  }, question), exercises[currentIndex].mp3 && __jsx("div", {
    className: "divRow"
  }, __jsx("h2", {
    style: {
      color: '#007BFF',
  ...
  }, question ? question : 'Hãy chọn từ bạn nghe thấy'), __jsx("button", {
...
//# sourceMappingURL=trac-nghiem.js.147578bae947daec5e0d.hot-update.js.map