...
/* harmony import */ var _components_tuDien_page__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../components/tuDien/page */ "./components/tuDien/page.js");
/* harmony import */ var _utils_analystics__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../utils/analystics */ "./utils/analystics.js");
/* harmony import */ var _components_tuDien_loader__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../components/tuDien/loader */ "./components/tuDien/loader.js");
/* harmony import */ var _components_tuDien_layout__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../../components/tuDien/layout */ "./components/tuDien/layout.js");
...
function (_Page) {
  ...
  function _default(props) {
    ...
    _this.state = {
      loading: true,
      content: '',
      chinesse: '喂(wèi) sợ\n羡慕(xiànmù)： Ngưỡng mộ\n呈(chéng)現：lộ ra, phơi bày, thể hiện, biểu diễn\n面(miàn)前(qián): trước mặt, trước mắt, phía trước',
      hanViet: '',
      bacKinh: '',
      tuMois: '',
      dict: {}
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(_default, [{
    ...
    value: function onChangeHandlerChuHan(e) {
      ...
      for (i = 0; i < words.length; i++) {
        try {
          ...
          word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_18__["replaceAll"])(word, '：', ':');
          word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_18__["replaceAll"])(word, ') ', ':');
          word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_18__["replaceAll"])(word, ') :', ':');
          word = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_18__["replaceAll"])(word, '):', ':');
          ...
          for (j = 0; j < hanBks.length; j++) {
            ...
            chuHan += hanbk[0];
            bacKinh += hanbk[1];
            if (!bacKinh || bacKinh == undefined) bacKinh = pinyin(chuHan);
            console.log('tuHaiBen', tuHaiBen, 'hanBks', hanBks, 'chuHan', chuHan, 'getHanViet(dict, chuHan)', getHanViet(dict, chuHan), 'bacKinh', bacKinh);
          }

          tuMois += chuHan + '(' + getHanViet(dict, chuHan) + ' - ' + bacKinh + ') ' + tuHaiBen[1] + '\n'; //chuHans.push({"chuHan":tuHaiBen[1].trim(), "hanViet":getHanViet(dict, means[2].trim()), "bacKinh":means[3].trim(), "nghia":means[1].trim()});
        } catch (e) {
    ...
    value: function render() {
      ...
      _utils_analystics__WEBPACK_IMPORTED_MODULE_15__["trackPageView"]("bt-convert"); // GA.trackEvent('TraTu', 'Han', word);

      return __jsx(_components_tuDien_layout__WEBPACK_IMPORTED_MODULE_17__["default"], Object(_babel_runtime_corejs2_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, this.props, {
        navmenu: false,
        container: false
      ...
      }))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Col"], null, __jsx("h4", null, "K\u1EBFt qu\u1EA3"), __jsx("span", null, "Vui l\xF2ng click l\xEAn t\u1EEBng ch\u1EEF \u0111\u1EC3 xem t\u1EEB \u0111i\u1EC3n"), __jsx(react_textarea_autosize__WEBPACK_IMPORTED_MODULE_13__["default"], {
        className: "txtAutoSize",
        id: "inputChuHan",
        placeholder: "Ch\u1EEF H\xE1n",
        value: tuMois
  ...
  return _default;
}(_components_tuDien_page__WEBPACK_IMPORTED_MODULE_14__["default"]);
...
//# sourceMappingURL=thembk.js.5da498f776dfbc45628d.hot-update.js.map