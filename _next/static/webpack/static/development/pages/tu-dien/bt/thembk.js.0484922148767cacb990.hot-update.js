    ...
    value: function onChangeHandlerChuHan(e) {
      ...
      for (i = 0; i < words.length; i++) {
        try {
          ...
          tuMois += chuHan + '(' + getHanViet(dict, chuHan) + ' - ' + bacKinh + ') ' + tuHaiBen[1]; //chuHans.push({"chuHan":tuHaiBen[1].trim(), "hanViet":getHanViet(dict, means[2].trim()), "bacKinh":means[3].trim(), "nghia":means[1].trim()});
        } catch (e) {
...
//# sourceMappingURL=thembk.js.0484922148767cacb990.hot-update.js.map