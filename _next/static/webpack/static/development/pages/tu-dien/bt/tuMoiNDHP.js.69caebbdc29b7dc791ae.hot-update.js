        ...
        try {
          ...
          if (!lodash__WEBPACK_IMPORTED_MODULE_13___default.a.isEmpty(word)) {
            ...
            for (j = 0; j < hanBks.length; j++) {
              ...
              var _hvbk = hanbk[1].split(' - '); // console.log('tuHaiBen',tuHaiBen,'hanbk',hanbk, 'chuHan',chuHan,'getHanViet(dict, chuHan)',getHanViet(dict, chuHan),'bacKinh',bacKinh);

            } //{chuHan:'滲透', hanViet:'sấm thấu', bacKinh:'shèn tòu', nghiaViet: 'thấm vào'}
            // tuMois += chuHan + '(' + getHanViet(dict, chuHan) + ' - ' + bacKinh + ') ' + tuHaiBen[1]  + '\n';


            tuMois += "{chuHan:'" + chuHan + "', hanViet:'" + hvbk[0] + ', bacKinh:' + "', nghiaViet: '";
            '(' + getHanViet(dict, chuHan) + ' - ' + bacKinh + ') ' + tuHaiBen[1] + '\n';
          }
        } catch (e) {
...
//# sourceMappingURL=tuMoiNDHP.js.69caebbdc29b7dc791ae.hot-update.js.map