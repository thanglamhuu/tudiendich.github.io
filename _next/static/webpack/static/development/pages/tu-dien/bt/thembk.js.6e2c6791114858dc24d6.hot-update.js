...
/* harmony import */ var chinese_to_pinyin__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! chinese-to-pinyin */ "./node_modules/chinese-to-pinyin/index.js");
/* harmony import */ var chinese_to_pinyin__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(chinese_to_pinyin__WEBPACK_IMPORTED_MODULE_13__);
...
function (_Page) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(_default, [{
      ...
      for (i = 0; i < words.length; i++) {
        try {
          ...
          for (j = 0; j < hanBks.length; j++) {
            ...
            chuHan += hanbk[0];
            if (hanbk.length == 2) bacKinh += ' ' + hanbk[1];else bacKinh += ' ' + chinese_to_pinyin__WEBPACK_IMPORTED_MODULE_13___default()(hanbk[0]);
    ...
    value: function render() {
      ...
      }))), __jsx(reactstrap__WEBPACK_IMPORTED_MODULE_11__["Col"], null, __jsx("h4", null, "K\u1EBFt qu\u1EA3"), __jsx("span", null, "Vui l\xF2ng click l\xEAn t\u1EEBng ch\u1EEF \u0111\u1EC3 xem t\u1EEB \u0111i\u1EC3n"), __jsx(react_textarea_autosize__WEBPACK_IMPORTED_MODULE_14__["default"], {
        className: "txtAutoSize",
        id: "inputChuHan",
        placeholder: "Ch\u1EEF H\xE1n",
        value: tuMois
...
//# sourceMappingURL=thembk.js.6e2c6791114858dc24d6.hot-update.js.map