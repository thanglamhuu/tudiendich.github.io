...
function (_Component) {
  ...
  function DictComponent(props) {
    ...
    _this.btnChuongTiep = _this.btnChuongTiep.bind(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this));
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(DictComponent, [{
    ...
    value: function btnLayChuong() {
      ...
      try {
        axios__WEBPACK_IMPORTED_MODULE_15___default.a.get("https://thanglamhuu.github.io/thaz.github.io/feibzw/dataHtml/".concat(chuonghdkt + 1, ".json")).then(function (res) {
          var content = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_20__["replaceAll"])(res.data.title + '\n' + res.data.content, '<p>', '\n');
          content = Object(_utils_utils__WEBPACK_IMPORTED_MODULE_20__["replaceAll"])(content, '</p>', '');

          _this4.setState({
            chuonghdkt: chuonghdkt + 1,
            typingChinesse: content
          });
        });
      } catch (err) {
    ...
    value: function trans() {
      ...
      translation_google__WEBPACK_IMPORTED_MODULE_10___default()(typingChinesse, {
        ...
        try {
          ...
          Object(firebase_database__WEBPACK_IMPORTED_MODULE_12__["update"])(dbRef, updates).then(function _callee2() {
            return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee2$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    react_hot_toast__WEBPACK_IMPORTED_MODULE_13___default.a.success('Đã lưu bản dịch');
          ...
          react_hot_toast__WEBPACK_IMPORTED_MODULE_13___default.a.error("L\u01B0u b\u1EA3n d\u1ECBch l\u1ED7i ".concat(err.message));
        } //=> en
...
//# sourceMappingURL=dich-truyen.js.86fbdae36447618086e7.hot-update.js.map